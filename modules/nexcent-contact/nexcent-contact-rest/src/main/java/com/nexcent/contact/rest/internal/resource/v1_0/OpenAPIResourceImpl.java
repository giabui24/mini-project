...
@Generated("")
@OpenAPIDefinition(
	info = @Info(description = "Submit contact requests to Nexcent.", license = @License(name = "Apache 2.0", url = "http://www.apache.org/licenses/LICENSE-2.0.html"), title = "Nexcent Contact", version = "v1.0")
)
@Path("/v1.0")
public class OpenAPIResourceImpl {
	...
	private final Set<Class<?>> _resourceClasses = new HashSet<Class<?>>() {
		{
			add(ContactRequestResourceImpl.class);
...
// LIFERAY-REST-BUILDER-HASH:1618789437