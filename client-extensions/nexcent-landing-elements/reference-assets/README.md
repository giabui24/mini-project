...
```bash
cd client-extensions/nexcent-landing-elements/reference-assets
...
```bash
node --test client-extensions/nexcent-landing-elements/reference-assets/headless-adapter.test.mjs
```
